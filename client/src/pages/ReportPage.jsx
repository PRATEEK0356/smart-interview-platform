...
const ReportPage = () => {
  ...
  if (error || !session) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-12 text-center bg-slate-50">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="space-y-2">
              <span className="inline-flex items-center space-x-2 px-3 py-1 rounded-lg text-xs font-extrabold bg-blue-50 text-blue-700 border border-blue-200">
            ...
            {/* Score Badge */}
            <div className="flex items-center space-x-4 bg-slate-50 p-5 rounded-xl border border-slate-200 self-start md:self-auto">
              <div className="w-16 h-16 rounded-xl bg-blue-600 text-white flex items-center justify-center font-black text-2xl shadow-sm border border-blue-700">
                {score}
              </div>
              <div>
                <span className="text-xs uppercase font-extrabold text-slate-500 block tracking-wider">Overall Score</span>
          ...
          {session.questions.map((q, idx) => (
            <div key={idx} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-1">
                <h4 className="text-xs font-extrabold uppercase tracking-wider text-slate-500">Candidate Verbal/Text Response</h4>
              ...
              {/* Qualitative Mentor Feedback (High Visual Priority) */}
              <div className="bg-blue-50/70 p-4 rounded-xl border border-blue-200 space-y-1">
                <h4 className="text-xs font-extrabold uppercase tracking-wider text-blue-800">Mentor Notes & Advice</h4>

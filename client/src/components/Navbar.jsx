    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <Link to="/dashboard" className="flex items-center space-x-3 group">
            ...
            <div>
              ...
              <span className="text-xs text-blue-600 block font-bold">Interview Practice Studio</span>
            </div>
          </Link>
      ...
      {isAvatarModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 font-sans">
          <div className="bg-white border-2 border-blue-500 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-6 relative animate-fadeIn text-slate-900">
            ...
            {uploadError && (
              <div className="p-3 bg-rose-50 border-2 border-rose-500 text-rose-700 text-xs font-bold rounded-xl">
                {uploadError}
              </div>
            )}
            ...
            <div className="space-y-3 pt-2">
              ...
              {user?.profileImage && (
                <button
                  ...
                  disabled={isUploading}
                  className="w-full bg-rose-50 text-rose-700 font-extrabold py-2.5 px-4 rounded-xl border-2 border-rose-400 hover:bg-rose-100 flex items-center justify-center space-x-2 transition-all disabled:opacity-50"
                >
              ...
              <button
                onClick={() => setIsAvatarModalOpen(false)}
                className="w-full bg-white text-slate-700 font-bold py-2.5 px-4 rounded-xl border-2 border-slate-200 hover:bg-slate-100 transition-colors"
              >
                Cancel
              </button>
            </div>
